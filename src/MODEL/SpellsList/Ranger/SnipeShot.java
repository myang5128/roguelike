...
public class SnipeShot implements Spells {
    String name = "SNIPE SHOT";
    int manaCost = 3;
    int damage = 5;
    int misfire = 10;
    int level = 0;
    String target = "ENEMY";
    String desc = "TIME SLOWS AROUND YOU AS YOU PREPARE FOR A DEVASTATING SHOT!";
    ...
    public int getManaCost() {
        switch (this.level) {
            ...
            case 2 -> this.manaCost = 4;
            case 3 -> this.manaCost = 6;
            case 4 -> this.manaCost = 8;
            case 5 -> this.manaCost = 11;
    ...
    public int getDamage() {
        return (int) (Math.random() * getRawDamage() + getRawDamage() + this.level);
    }
    ...
    public int getRawDamage() {
        switch (this.level) {
            ...
            case 5 -> this.damage = 17;
            case 6 -> this.damage = 21;
        }
        return this.damage;
    }
