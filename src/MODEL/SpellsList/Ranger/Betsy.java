...
public class Betsy implements Spells {
    ...
    int level = 0;
    String target = "ENEMY";
    String desc = "SUMMON YOUR BEAR COMPANION TO MAUL YOUR FOES!";
    ...
    public int getDamage() {
        return (int) ((Math.random() * this.level + getRawDamage()) * 1.6);
    }
    ...
    public int getRawDamage() {
        switch (this.level) {
            ...
            case 4 -> this.damage = 11;
            case 5 -> this.damage = 14;
            case 6 -> this.damage = 18;
        }
        return this.damage;
    }
