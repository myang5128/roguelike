...
public class CharCreateText {
    ...
    public CharCreateText() {
        ...
        dialText.put("GETCLASS", "NOW, REMEMBER AS MUCH AS YOU CAN FROM YOUR PAST LIVE. WHAT WAS YOUR PROFESSION? YOU DON'T HAVE THE BODY OR THE EYES OF A PEASANT, SOME BOLD SOLDIER PERHAPS, " +
