...
public class CharCreateText {
    ...
    public CharCreateText() {
        ...
        dialText.put("GETCLASS", """
                NOW, REMEMBER AS MUCH AS YOU CAN FROM YOUR PAST LIFE. WHAT WAS YOUR PROFESSION? YOU DON'T HAVE THE BODY OR THE EYES OF A PEASANT, SOME BOLD SOLDIER PERHAPS, OR A STEALTHY ASSASSIN, OR, OH MY, EVEN A CRAFTY MAGE, PERHAPS?
                *available classes: DRUID, KNIGHT, MAGE, PALADIN, RANGER, ROGUE*
                """);
        dialText.put("GETCLASSAGAIN", """
                I'M SORRY, MY HEARING MIGHT HAVE GOTTEN WORSE THROUGHOUT THE YEARS, BUT I COULDN'T MAKE OUT WHAT YOU SAID. WHAT PROFESSION WERE YOU AGAIN?
                *available classes: DRUID, KNIGHT, MAGE, PALADIN, RANGER, ROGUE*
                """);
    }
